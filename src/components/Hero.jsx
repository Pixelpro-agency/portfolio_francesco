  ...
  return (
    <section className="relative w-full h-screen mx-auto">
      <div className={`${styles.paddingX} absolute insert-0 top-[120px] max-w-7xl mx-auto flex flex-row items-start gap-5`}>
        ...
        <div>
          <h1 className={`${styles.heroHeadText}`}>Ciao, io sono <span className="text-[#915eff]">Francesco</span></h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            Non c'è mai una seconda occasione... <br className="sm:block hidden" /> ...per fare una prima impressione
          </p>
        </div>
      </div>
